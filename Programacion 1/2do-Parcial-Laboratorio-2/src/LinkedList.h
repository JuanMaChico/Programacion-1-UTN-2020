...
/*
 * \brief recorro la lista y aplica el filtro pasado con el puntero a funcion
 *  \param puntero a lista
 *  \param puntero a funcion que aplica filtro
 *  \param selector de orden que tiene que aplicar la funcion enviada por puntero
 *  \return retorna la lista ordenada
 */
LinkedList* ll_map(LinkedList* this, int (*pFunc)(void*));

/*
 * \brief recorre la lsita aplicando un filtro
 *  \param puntero a la lista
 *  \param puntero a funcion que aplica el filtro
 ...
 *  \param Puntero a la lista
 *  \param puntero a funcion que aplicara el criterio para contar
 *  \return retorna la cantidad de elementos que cumplen con el filtro pasado por el puntero a funcion
 */
